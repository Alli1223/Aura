...
- [ ] **notifications-webhooks** — Outbound webhooks on events (media added, playback started) + admin API to manage them: webhook store, HMAC-signed fire-and-forget dispatcher, event emission from the scanner & playback-decision, admin CRUD + test endpoint
